<?php 
	...
	if(isset($_SESSION['usuario']) && isset($_SESSION['senha'])){ header('location:home.php'); }
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
	<title>SRSaúde - Login</title>
...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="../controller/sistema.php" method="post">
      <input type="hidden" name="tipo" value="AdministradorLogar">
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('../images/bg-img2.jpg');">
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							<?php echo utf8_encode($adm->postoTelefones());?>
						</span>
					</div>
				</div>
			</div>
